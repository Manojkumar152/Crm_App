...
public class ProposalAdapter extends RecyclerView.Adapter<ProposalAdapter.MyHolder> {
    ...
    public ProposalAdapter(FragmentActivity activity, ArrayList<String> data) {
        this.data = data;
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(activity).inflate(R.layout.proposal_list_items,viewGroup,false);
